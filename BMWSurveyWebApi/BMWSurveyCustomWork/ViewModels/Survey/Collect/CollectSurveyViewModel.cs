...
namespace BMWSurvey
{
    //use next to convert to json from c#
    //https://dotnetfiddle.net/dEqIUC
    public class CollectSurveyViewModel
    {
        ...
        #endregion
        #region ReturnFlag
        public ReturnFlag ReturnFlag { get; set; }
        #endregion
        #region Models
        public IList<CollectSurveyModelViewModel> Models;
        #endregion
